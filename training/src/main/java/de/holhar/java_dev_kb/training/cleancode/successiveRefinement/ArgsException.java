...
import static de.holhar.java_dev_kb.training.cleancode.successiveRefinement.ArgsException.ErrorCode.OK;
    ...
    public String errorMessage() {
        switch (errorCode) {
            ...
            case MISSING_INTEGER:
                return String.format("Could not find integer paramter for -%c.", errorArgumentId);
            case INVALID_DOUBLE:
