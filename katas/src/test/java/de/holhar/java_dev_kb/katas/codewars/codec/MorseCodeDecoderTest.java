...
public class MorseCodeDecoderTest {
    ...
    @Test
    public void testMorseCodeDecoder_basicBitDecoding1() throws Exception {
        assertThat(MorseCodeDecoder.decodeMorse(MorseCodeDecoder.decodeBits("10001")), is("EE"));
    }

    @Test
    public void testMorseCodeDecoder_basicBitDecoding2() throws Exception {
        assertThat(MorseCodeDecoder.decodeMorse(MorseCodeDecoder.decodeBits("101")), is("I"));
    }

    // does not make any sense at all...
    @Test
    public void testMorseCodeDecoder_testLongMessageHandling() throws Exception {
    ...
    @Test
    public void testMorseCodeDecoder_testMultipleBitsPerDotHandling1() throws Exception {
    ...
    @Test
    public void testMorseCodeDecoder_testMultipleBitsPerDotHandling2() throws Exception {
